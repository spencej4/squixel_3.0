...
class AddToDBHover extends Component   {
  constructor(props) {
        super(props);
        this.state = {
    ...
    removeImageFromDatabase (event, caller) {
        event.preventDefault();
        event.stopPropagation();
        ...
        fetch('/api/delete-image',{
            ...
            if (caller === 'userCollectionDeleteImage'){
                // alert('user deleted collection image')
